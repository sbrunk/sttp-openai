...
import org.openapitools.client.model.CreateClassificationRequest
import org.openapitools.client.model.CreateClassificationResponse
...
import org.openapitools.client.model.CreateSearchResponse
...
import org.openapitools.client.model.ListEnginesResponse
...
class OpenAIApi(baseUrl: String) {
  ...
  /**
   * Expected answers:
   *   code 200 : CreateAnswerResponse (OK)
   * 
   * @param createAnswerRequest 
   */
  def createAnswer(createAnswerRequest: CreateAnswerRequest
): Request[Either[ResponseException[String, Exception], CreateAnswerResponse], Any] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/answers")
      .contentType("application/json")
      .body(createAnswerRequest)
      .response(asJson[CreateAnswerResponse])
  ...
  /**
   * Expected answers:
   *   code 200 : CreateClassificationResponse (OK)
   * 
   * @param createClassificationRequest 
   */
  def createClassification(createClassificationRequest: CreateClassificationRequest
): Request[Either[ResponseException[String, Exception], CreateClassificationResponse], Any] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/classifications")
      .contentType("application/json")
      .body(createClassificationRequest)
      .response(asJson[CreateClassificationResponse])
...
//      .response(asJson[ImagesResponse])
  ...
  /**
   * Expected answers:
   *   code 200 : CreateSearchResponse (OK)
   * 
   ...
   */
  def createSearch(engineId: String, createSearchRequest: CreateSearchRequest
): Request[Either[ResponseException[String, Exception], CreateSearchResponse], Any] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/engines/${engineId}/search")
      .contentType("application/json")
      .body(createSearchRequest)
      .response(asJson[CreateSearchResponse])
...
//      .response(asJson[CreateTranslationResponse])
  ...
  /**
   * Expected answers:
   *   code 200 : ListEnginesResponse (OK)
   */
  def listEngines(
): Request[Either[ResponseException[String, Exception], ListEnginesResponse], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/engines")
      .contentType("application/json")
      .response(asJson[ListEnginesResponse])
   ...
   */
  def retrieveEngine(engineId: String
): Request[Either[ResponseException[String, Exception], Engine], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/engines/${engineId}")
      .contentType("application/json")
      .response(asJson[Engine])
